<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @can('news-list')
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'news-management') == true ? 'active' : '' }}" href="{{ route('news.index') }}">
                    <div class="icon icon-setting icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            @can('topics-list')
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'news-management') == true ? 'active' : '' }}" href="{{ route('topics.index') }}">
                    <div class="icon icon-setting icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            @can('article-list')
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'article-management') == true ? 'active' : '' }}" href="{{ route('articles.index') }}">
                    <div class="icon icon-setting icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
