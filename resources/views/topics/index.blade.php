            ...
            <div class="card-header  ">
                <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                        <a href="{{ route('topics.create') }}" class="btn btn-success me-2" style="">Add New
                            Topic</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                            <a href="{{ route('topics.show', $topic) }}" class="btn btn-info me-2">View</a>
                                            <a href="{{ route('topics.edit', $topic) }}" class="btn btn-primary me-2">Edit</a>
