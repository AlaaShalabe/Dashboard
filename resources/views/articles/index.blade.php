...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'articles Management'])
                ...
                <div class="card-header  ">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-end">
                            <a href="{{ route('articles.create') }}" class="btn btn-success me-2" style="">Add News</a>
                        </div>
                    </div>
                                    ...
                                    @foreach ($articles as $article)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-sm font-weight-bold mb-0"></p> {{ $article->user->username }}
                                            </td>
                                            <td class="align-middle text-center text-sm">
